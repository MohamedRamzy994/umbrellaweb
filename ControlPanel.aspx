<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ControlPanel.aspx.cs" Inherits="ControlPanel" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('a[href="ControlPanel.aspx"]').parent().addClass('active');
            DoWork();
            ...
            <div id="main" style="margin-left: 0px;">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="pull-left">
                            <h2 meta:resourcekey="hCP" runat="server">Control Panel</h2>
                        </div>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="box box-color box-bordered">
                                <div class="box-title">
                                    <h3 meta:resourcekey="hCPS" runat="server">
                                        <i class="icon-wrench"></i>Control Panel
                                    </h3>
                                </div>
                                <div class="box-content">
                                    <ul class="tiles">
                                        <asp:PlaceHolder ID="phControlPanel" runat="server"></asp:PlaceHolder>
