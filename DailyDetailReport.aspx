<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DailyDetailReport.aspx.cs"
    Inherits="DailyDetailReport" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<head id="Head1" runat="server">
    ...
    <title>Daily Detail Report</title>
    <uc1:ucStyle_Scripts runat="server" ID="ucStyle_Scripts" />
    <script type="text/javascript">
        $(document).ready(function () {
            /// Eng.Moustafa Ebrahem
            /// Eng.Moustafa20@Gmail.com
            $('a[href="DailyDetailReport.aspx"]').parent().addClass('active').parent().parent().addClass('active');
            DoWork();
