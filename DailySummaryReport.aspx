<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DailySummaryReport.aspx.cs"
    Inherits="DailySummaryReport" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('a[href="DailySummaryReport.aspx"]').parent().addClass('active').parent().parent().addClass('active');
            DoWork();
        ...
        function DoWork() {
            ...
            $('#btnResultPrint').unbind('click').bind('click', function (event) {
                ...
                var str = "FinancialsReportsView.aspx?data=period," + $('#txtDateFrom').val() + "," + $('#txtDateTo').val();
            ...
            <div id="main" style="margin-left: 0px;">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="pull-left">
                            <h2 meta:resourcekey="h2Daily_Summary_Report" runat="server">Daily Summary Report</h2>
                        </div>
                                    ...
                                    <div class="box box-color box-bordered">
                                        <div class="box-title">
                                            <h3 meta:resourcekey="h3Daily_Summary_Report" runat="server">
                                                <i class="glyphicon-settings"></i>Daily Summary Report
                                            </h3>
                                            <div class="actions">
                                                        ...
                                                        <div class="span12">
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    ...
                                                                    &nbsp;&nbsp;
                                                                <input id="txtDateTo" runat="server" meta:resourcekey="txtDateTo" type="text" placeholder="Date To" class="input-small"
                                                ...
                                                <div class="scroll scrollbig3">
                                                    <asp:GridView ID="gvResults" runat="server" CssClass="tblbordered" Width="100%" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="start_balance" HeaderText="Start Balance" meta:resourcekey="BoundFieldResource2" />
                                                            <asp:BoundField DataField="income" HeaderText="Income" meta:resourcekey="BoundFieldResource3" />
                                                            <asp:BoundField DataField="outcome" HeaderText="Outcome" meta:resourcekey="BoundFieldResource4" />
                                                            <asp:BoundField DataField="withdrawals" HeaderText="Withdrawals" meta:resourcekey="BoundFieldResource5" />
                                                            <asp:BoundField DataField="Balance" HeaderText="Balance" meta:resourcekey="BoundFieldResource6" />
                                                            <asp:BoundField DataField="visits_count" HeaderText="Visits Count" meta:resourcekey="BoundFieldResource7" />
                                                            <asp:BoundField DataField="visits_total" HeaderText="Visits Total" meta:resourcekey="BoundFieldResource8" />
                                                            <asp:BoundField DataField="encash_count" HeaderText="EV Count" meta:resourcekey="BoundFieldResource9" />
                                                            <asp:BoundField DataField="encash_total" HeaderText="EV Total" meta:resourcekey="BoundFieldResource10" />
                                                            <asp:BoundField DataField="ret_visits_count" HeaderText="Returned Visits Count" meta:resourcekey="BoundFieldResource11" />
                                                            <asp:BoundField DataField="ret_visits_total" HeaderText="Returned Visits Total" meta:resourcekey="BoundFieldResource12" />
                                                            <asp:BoundField DataField="pay_count" HeaderText="PV Count" meta:resourcekey="BoundFieldResource13" />
                                                            <asp:BoundField DataField="pay_total" HeaderText="PV Total" meta:resourcekey="BoundFieldResource14" />
                                                            <asp:BoundField DataField="with_count" HeaderText="Withdrawals Count" meta:resourcekey="BoundFieldResource15" />
                                                            <asp:BoundField DataField="with_total" HeaderText="Withdrawals Total" meta:resourcekey="BoundFieldResource16" />
                                                        </Columns>
