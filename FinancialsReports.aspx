<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FinancialsReports.aspx.cs"
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('a[href="FinancialsReports.aspx"]').parent().addClass('active').parent().parent().addClass('active');
            DoWork();
            ...
            <div id="main" style="margin-left: 0px;">
                <div class="container-fluid">
                    <div class="page-header">
                        <div class="pull-left">
                            <h2 meta:resourcekey="h2Financials_Reports" runat="server">Financials Reports</h2>
                        </div>
                            ...
                            <div class="box box-color box-bordered">
                                <div class="box-title">
                                    <h3 meta:resourcekey="h3Financials_Reports" runat="server">
                                        <i class="glyphicon-coins"></i>Financials Reports
                                    </h3>
                                </div>
                                <div class="box-content nopadding">
                                    <ul class="rep-list">
                                        <li><a href="DailySummaryReport.aspx" class="rep-link" meta:resourcekey="Daily_Summary_Report_Within_Period" runat="server">Daily Summary Report Within Period</a>
                                        </li>
                                        <li><a href="DailyDetailReport.aspx" class="rep-link" meta:resourcekey="Daily_Detail_Report_Within_Period" runat="server">Daily Detail Report Within Period</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
