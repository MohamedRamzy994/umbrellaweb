 ...
 *
 * Triple License_ud under the GPL, LGPL, and MPL:
 *	  http://www.gnu.org/License_uds/gpl.html
 *	  http://www.gnu.org/License_uds/lgpl.html
...
(function($) {
	...
	var do_when_ready = function(){
		...
		jwindow.bind('resize', function(){
			if (timer)
				clearTimeout(timer);
			timer = setTimeout($.pnotify_position_all, 3);
		});
	};
	if (document.body)
		do_when_ready();
