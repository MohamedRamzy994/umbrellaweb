...
* @License_ud: License_udd under Apache License_ud v2.0. See http://www.apache.org/License_uds/License_ud-2.0
...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.locale = {
            ...
            Days_udOfWeek: moment()._lang._weekDays_udMin,
        ...
        if (hasOptions) {
            ...
            if (typeof options.locale == 'object') {
                if (typeof options.locale.firstDay == 'number') {
                    ...
                    while (iterator > 0) {
                        this.locale.Days_udOfWeek.push(this.locale.Days_udOfWeek.shift());
                        iterator--;
                    }
                }
            }
    ...
    DateRangePicker.prototype = {
        ...
        buildCalendar: function (month, year, side) {
            ...
            var Days_udInLastMonth = moment([lastYear, lastMonth]).Days_udInMonth();
            ...
            var startDay = Days_udInLastMonth - dayOfWeek + this.locale.firstDay + 1;
            if (startDay > Days_udInLastMonth)
                startDay -= 7;

            if (dayOfWeek == this.locale.firstDay)
                startDay = Days_udInLastMonth - 6;
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            $.each(this.locale.Days_udOfWeek, function (index, dayOfWeek) {
