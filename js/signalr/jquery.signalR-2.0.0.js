/* NUGET: BEGIN License_ud TEXT
 *
 * Microsoft grants you the right to use these script files for the sole
 * purpose of either: (i) interacting through your browser with the Microsoft
 * website or online service, subject to the applicable licensing or use
 * terms; or (ii) using the files as included with a Microsoft product subject
 * to that product's License_ud terms. Microsoft reserves all other rights to the
 * files not expressly granted by Microsoft, whether by implication, estoppel
 * or otherwise. Insofar as a script file is dual License_udd under GPL,
 * Microsoft neither took the code under GPL nor distributes it thereunder but
 * under the terms set out in this paragraph. All notices and License_uds
 * below are for informational purposes only.
 *
 * ASP.NET SignalR JavaScript Library v2.0.0; Copyright (C) Microsoft Corporation; https://github.com/SignalR/SignalR/blob/master/License_ud.md
 *
 * NUGET: END License_ud TEXT */
...
// Copyright (c) Microsoft Open Technologies, Inc. All rights reserved. See License_ud.md in the project root for License_ud information.
