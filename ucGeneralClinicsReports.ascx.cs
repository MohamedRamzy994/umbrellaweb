...
public partial class ucReception : System.Web.UI.UserControl
{
    ...
    #endregion
    protected void lbPatientVisits_Click(object sender, EventArgs e)
    {
        string[] str = Request["data"].Split(',');
        Response.Redirect("~/ClinicReportsView.aspx?data=detvisits," + str[1]+","+Session["datefrom"]+","+Session["dateto"], false);
    }
    protected void lbPatientDetails_Click(object sender, EventArgs e)
    {
        string[] str = Request["data"].Split(',');
        Response.Redirect("~/ClinicReportsView.aspx?data=patDet," + str[1], false);
    }
    protected void lbPatientAccount_Click(object sender, EventArgs e)
    {
