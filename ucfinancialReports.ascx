<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucfinancialReports.ascx.cs" Inherits="ucReception" %>
...
<div id="navigation" class="navbar-fixed-top">
    ...
    <div class="container-fluid">
        ...
        <ul id="divDailyDet" runat="server" visible="false" class='main-nav'>
            ...
            <ul id="divDailyPeriod" runat="server" visible="false" class='main-nav'>
                <li>
                    <asp:LinkButton ID="lbDailySummary" runat="server" OnClick="lbDailySummary_Click" meta:resourcekey="lbDailySummaryResource1">Daily Summary</asp:LinkButton></li>
                <li>
                    <asp:LinkButton ID="lbDailyDetail" runat="server" OnClick="lbDailyDetail_Click" meta:resourcekey="lbDailyDetailResource1">Daily Detail</asp:LinkButton></li>
            </ul>
        <div class="user">
            <ul class="icon-nav">
